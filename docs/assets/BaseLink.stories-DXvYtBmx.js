import{B as e}from"./BaseLink-BYp1-IWJ.js";import"./constants-BA52rpFi.js";import"./vue.esm-bundler-DsKf3Hbt.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const r={href:e.props.href.default,to:e.props.to.default,routerComponentName:e.props.routerComponentName.default},k={component:e,title:"Components/BaseLink",argTypes:{href:{control:{type:"text"}},to:{control:{type:"text"}},routerComponentName:{control:{type:"text"}},default:{control:{type:"text"}}},args:{href:r.href,to:r.to,routerComponentName:r.routerComponentName,default:""},render:f=>({components:{BaseLink:e},props:Object.keys(e.props),setup(){return{args:f}},template:`<BaseLink
      :href="args.href"
      :to="args.to"
