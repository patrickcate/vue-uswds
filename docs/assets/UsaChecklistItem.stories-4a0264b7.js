import{U as a}from"./UsaChecklistItem-0ae8799d.js";import"./vue.esm-bundler-d9807bdf.js";const r={checked:a.props.checked.default},I={component:a,title:"Components/UsaChecklistItem",argTypes:{checked:{control:{type:"boolean"}},ariaLabel:{control:{type:"text"}}},args:{checked:r.checked,ariaLabel:""},decorators:[()=>({template:'<ul class="usa-checklist" style="margin-left: 40px"><story /></ul>'})],render:c=>({components:{UsaChecklistItem:a},props:Object.keys(a.props),setup(){return{args:c}},template:`<UsaChecklistItem :checked="args.checked" :aria-label="args.ariaLabel">
