import{U as s}from"./UsaFooterMenu-30d8af9e.js";import"./vue.esm-bundler-d9807bdf.js";import"./constants-fce87d39.js";import"./BaseLink-378e51d3.js";import"./_plugin-vue_export-helper-c27b6911.js";const o=[{href:"/test-1",text:"Test Item 1"},{to:"/test-2",text:"Test Item 2"},{id:"test-3",href:"/test-3",text:"Test Item 3"},{id:"test-4",href:"/test-4",text:"Test Item 4"}],r={items:s.props.items.default(),customClasses:s.props.customClasses.default()},F={component:s,title:"Components/UsaFooterMenu",argTypes:{items:{control:{type:"object"}},customClasses:{control:{type:"object"}}},args:{items:r.items,customClasses:r.customClasses},decorators:[()=>({template:'<div class="usa-footer"><div class="usa-footer__nav"><story /></div></div>'})],render:l=>({components:{UsaFooterMenu:s},props:Object.keys(s.props),setup(){return{args:l}},template:`<UsaFooterMenu
    :items="args.items"
