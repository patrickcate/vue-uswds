import{_ as s}from"./UsaNavSubmenu-mi3c0ZsS.js";import{p as u,l as m}from"./vue.esm-bundler-DlC1_45x.js";import"./constants-BA52rpFi.js";const e={cols:s.props.cols.default,customClasses:s.props.customClasses.default()},C={component:s,title:"Components/UsaNavSubmenu",argTypes:{cols:{control:{type:"number"}},customClasses:{control:{type:"object"}},default:{control:{type:"text"}}},args:{cols:e.cols,customClasses:e.customClasses,default:""},render:a=>({components:{UsaNavSubmenu:s},props:Object.keys(s.props),setup(){return{args:a}},template:`<UsaNavSubmenu
  ...
  </UsaNavSubmenu>`}),decorators:[()=>({template:'<ul class="usa-dark-background"><story /></ul>',provide:{dropdownId:m("sb-dropdown-id"),dropdownItems:u({"sb-dropdown-id":!0})}})]},t={args:{...e,default:'<li class="usa-nav__submenu-item"><a href="">Item 1</a></li>'},name:"Default",parameters:{docs:{source:{code:'<UsaNavSubmenu><li class="usa-nav__submenu-item"><a href="">Item 1</a></li></UsaNavSubmenu>'}}}},n={args:{...e,default:'<li class="usa-nav__submenu-item"><a href="">Item 1</a></li>'},decorators:[()=>({template:"<story />",provide:{dropdownId:m("sb-dropdown-id"),dropdownItems:u({"sb-dropdown-id":!0}),isMegamenu:!0}})],name:"Megamenu",parameters:{docs:{source:{code:'<UsaNavSubmenu><li class="usa-nav__submenu-item"><a href="">Item 1</a></li></UsaNavSubmenu>'}}}},o={args:{...e,cols:3,col1:'<li class="usa-nav__submenu-item"><a href="">Item 1</a></li>',col2:'<li class="usa-nav__submenu-item"><a href="">Item 2</a></li>',col3:'<li class="usa-nav__submenu-item"><a href="">Item 3</a></li>'},decorators:[()=>({template:"<story />",provide:{dropdownId:m("sb-dropdown-id"),dropdownItems:u({"sb-dropdown-id":!0}),isMegamenu:!0}})],name:"Multiple Columns Megamenu",parameters:{docs:{source:{code:'<UsaNavSubmenu :cols="3"><template #col1><li class="usa-nav__submenu-item"><a href="">Item 1</a></li></template><template #col2><li class="usa-nav__submenu-item"><a href="">Item 2</a></li></template><template #col3><li class="usa-nav__submenu-item"><a href="">Item 3</a></li></template></UsaNavSubmenu>'}}}},l={args:{...e,cols:3,customClasses:{gridRow:["test-row"],gridCol:["test-col"]},col1:'<li class="usa-nav__submenu-item"><a href="">Item 1</a></li>',col2:'<li class="usa-nav__submenu-item"><a href="">Item 2</a></li>',col3:'<li class="usa-nav__submenu-item"><a href="">Item 3</a></li>'},decorators:[()=>({template:"<story />",provide:{dropdownId:m("sb-dropdown-id"),dropdownItems:u({"sb-dropdown-id":!0}),isMegamenu:!0}})],name:"Custom Classes",parameters:{docs:{source:{code:`<UsaNavSubmenu :cols="3" :custom-classes="{ gridRow: ['test-row'], gridCol: ['test-col'] }"><template #col1><li class="usa-nav__submenu-item"><a href="">Item 1</a></li></template><template #col2><li class="usa-nav__submenu-item"><a href="">Item 2</a></li></template><template #col3><li class="usa-nav__submenu-item"><a href="">Item 3</a></li></template></UsaNavSubmenu>`}}}};var r,c,i;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
