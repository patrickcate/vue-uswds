...
}`},{name:"modelValue",global:!1,description:"",tags:[],required:!1,type:"any",declarations:[],schema:"any",default:'""'},{name:"tile",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]},default:"false"}],events:[{name:"update:modelValue",description:"",tags:[],type:"any[]",signature:'(event: "update:modelValue", ...args: any[]): void',declarations:[],schema:["any"]}],slots:[{name:"default",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}},{name:"description",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}}],exposed:[{name:"description",type:"string",description:"",declarations:[],schema:"string"},{name:"id",type:"string",description:"",declarations:[],schema:"string"},{name:"label",type:"string",description:"",declarations:[],schema:"string"},{name:"customClasses",type:"Record<string, any>",description:"",declarations:[],schema:"Record<string, any>"},{name:"modelValue",type:"any",description:"",declarations:[],schema:"any"},{name:"tile",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}}],sourceFiles:"/home/runner/work/vue-uswds/vue-uswds/src/components/UsaRadio/UsaRadio.vue"};const e={tile:t.props.tile.default,modelValue:t.props.modelValue.default,label:t.props.label.default,description:t.props.description.default,id:t.props.id.default,customClasses:t.props.customClasses.default()},Ce={component:t,title:"Components/UsaRadio",argTypes:{tile:{control:{type:"boolean"}},modelValue:{control:{type:"text"}},label:{control:{type:"text"}},description:{control:{type:"text"},table:{category:"props"}},id:{control:{type:"text"}},default:{control:{type:"text"}},"slot:description":{control:{type:"text"},name:"description",table:{category:"slots"}}},args:{tile:e.tile,modelValue:e.modelValue,label:e.label,description:e.description,id:e.id,customClasses:e.customClasses,default:"","slot:description":""},decorators:[()=>({template:'<div class="usa-form usa-form--large"><story /></div>'})],render:a=>({components:{UsaRadio:t},props:Object.keys(t.props),setup(){const b=be(a.modelValue);return{args:a,modelValue:b}},template:`<UsaRadio
    v-bind="args.$attrs"
    :tile="args.tile"
    :label="args.label"
