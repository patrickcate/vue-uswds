...
}`},{name:"ariaLabel",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string",default:'"Secondary navigation"'},{name:"items",global:!1,description:"",tags:[],required:!1,type:"unknown[]",declarations:[],schema:{kind:"array",type:"unknown[]"},default:"[]"}],events:[],slots:[{name:"before",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}},{name:"default",type:"{ items: unknown[]; }",description:"",declarations:[],schema:{kind:"object",type:"{ items: unknown[]; }"}},{name:"after",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}}],exposed:[{name:"customClasses",type:"Record<string, any>",description:"",declarations:[],schema:"Record<string, any>"},{name:"ariaLabel",type:"string",description:"",declarations:[],schema:"string"},{name:"items",type:"unknown[]",description:"",declarations:[],schema:{kind:"array",type:"unknown[]"}}],sourceFiles:"/home/runner/work/vue-uswds/vue-uswds/src/components/UsaSidenav/UsaSidenav.vue"};const s={ariaLabel:a.props.ariaLabel.default,items:[{to:"/test-page-1",text:"Test Page 1"},{to:"/test-page-2",text:"Test Page 2",children:[{to:"/test-page-2-1",text:"Test Page 2.1"},{to:"/test-page-2-2",text:"Test Page 2.2"}]},{to:"/test-page-3",text:"Test Page 3"}],customClasses:a.props.customClasses.default()},H={component:a,title:"Components/UsaSidenav",argTypes:{ariaLabel:{control:{type:"text"}},items:{control:{type:"object"}},customClasses:{control:{type:"object"}},before:{control:{type:"text"}},default:{control:{type:"text"}},after:{control:{type:"text"}}},args:{ariaLabel:s.ariaLabel,items:s.items,customClasses:s.customClasses,before:"",default:"",after:""},render:e=>({components:{UsaSidenav:a},props:Object.keys(a.props),setup(){return{args:e}},template:`<UsaSidenav
