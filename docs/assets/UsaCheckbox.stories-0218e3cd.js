import{s as C,c as U,A as de,U as ue,a as j,m as pe,r as D,n as k,t as me,o as v,d as V,v as P,l as be}from"./vue.esm-bundler-d9807bdf.js";import{n as he}from"./unique-id-dcbd9804.js";import"./common-c0b90c12.js";import"./constants-fce87d39.js";const Ce=["id"],ke=["htmlFor"],fe={inheritAttrs:!1},ne=Object.assign(fe,{__name:"UsaCheckbox",props:{tile:{type:Boolean,default:!1},modelValue:{type:Boolean,default:!1},label:{type:String,default:""},description:{type:String,default:""},id:{type:String,default:""},customClasses:{type:Object,default:()=>({component:[],label:[],description:[]})}},emits:["update:modelValue"],setup(s,{emit:b}){const le=b,h=s,f=C(()=>h.id||he("usa-checkbox")),g=C({get(){return h.modelValue},set(o){le("update:modelValue",o)}}),ce=C(()=>[{"usa-checkbox__input--tile":h.tile}]);return(o,x)=>{var y,S,T;return v(),U("div",{class:k(["usa-checkbox",(y=s.customClasses)==null?void 0:y.component])},[de(j("input",pe(o.$attrs,{id:f.value,"onUpdate:modelValue":x[0]||(x[0]=ie=>g.value=ie),class:["usa-checkbox__input",ce.value],type:"checkbox"}),null,16,Ce),[[ue,g.value]]),j("label",{class:k(["usa-checkbox__label",(S=s.customClasses)==null?void 0:S.label]),htmlFor:f.value},[D(o.$slots,"default",{},()=>[V(P(s.label),1)]),s.description||o.$slots.description?(v(),U("span",{key:0,class:k(["usa-checkbox__label-description",(T=s.customClasses)==null?void 0:T.description])},[D(o.$slots,"description",{},()=>[V(P(s.description),1)])],2)):me("",!0)],10,ke)],2)}}}),t=ne;ne.__docgenInfo={exportName:"default",displayName:"UsaCheckbox",type:1,props:[{name:"key",global:!0,description:"",tags:[],required:!1,type:"PropertyKey",declarations:[],schema:{kind:"enum",type:"PropertyKey",schema:["string","number","symbol"]}},{name:"ref",global:!0,description:"",tags:[],required:!1,type:"VNodeRef",declarations:[],schema:{kind:"enum",type:"VNodeRef",schema:["string","Ref<any, any>",{kind:"event",type:"(ref: Element | ComponentPublicInstance<{}, {}, {}, {}, {}, {}, {}, {}, false, ComponentOptionsBase<any, any, any, any, any, any, any, any, any, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>, ... 4 more ..., any>, refs: Record<...>): void"}]}},{name:"ref_for",global:!0,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"ref_key",global:!0,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"},{name:"class",global:!0,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"},{name:"style",global:!0,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"},{name:"id",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string",default:'""'},{name:"label",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string",default:'""'},{name:"customClasses",global:!1,description:"",tags:[],required:!1,type:"Record<string, any>",declarations:[],schema:"Record<string, any>",default:`() => {
    return {
        component: [],
        label: [],
        description: [],
    };
}`},{name:"description",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string",default:'""'},{name:"modelValue",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]},default:"false"},{name:"tile",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]},default:"false"}],events:[{name:"update:modelValue",description:"",tags:[],type:"any[]",signature:'(event: "update:modelValue", ...args: any[]): void',declarations:[],schema:["any"]}],slots:[{name:"default",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}},{name:"description",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}}],exposed:[{name:"id",type:"string",description:"",declarations:[],schema:"string"},{name:"label",type:"string",description:"",declarations:[],schema:"string"},{name:"customClasses",type:"Record<string, any>",description:"",declarations:[],schema:"Record<string, any>"},{name:"description",type:"string",description:"",declarations:[],schema:"string"},{name:"modelValue",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"tile",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}}],sourceFiles:"/home/runner/work/vue-uswds/vue-uswds/src/components/UsaCheckbox/UsaCheckbox.vue"};const e={tile:t.props.tile.default,modelValue:t.props.modelValue.default,label:t.props.label.default,description:t.props.description.default,id:t.props.id.default,customClasses:t.props.customClasses.default()},Te={component:t,title:"Components/UsaCheckbox",argTypes:{tile:{control:{type:"boolean"}},modelValue:{control:{type:"boolean"}},label:{control:{type:"text"}},description:{control:{type:"text"}},id:{control:{type:"text"}},default:{control:{type:"text"}},"slot:description":{control:{type:"text"}}},args:{tile:e.tile,modelValue:e.modelValue,label:e.label,description:e.description,id:e.id,customClasses:e.customClasses,default:"","slot:description":""},decorators:[()=>({template:'<div class="usa-form usa-form--large"><story /></div>'})],render:s=>({components:{UsaCheckbox:t},props:Object.keys(t.props),setup(){const b=be(s.modelValue);return{args:s,modelValue:b}},template:`<UsaCheckbox
    v-bind="args.$attrs"
    :tile="args.tile"
    :label="args.label"
...
}`,...(re=(ae=m.parameters)==null?void 0:ae.docs)==null?void 0:re.source}}};const Ue=["DefaultCheckbox","WithDescriptionCheckbox","CheckedByDefaultCheckbox","TileCheckbox","TileWithDescriptionCheckbox","TileCheckedByDefaultCheckbox","LabelSlotCheckbox","DescriptionSlotCheckbox","CustomIdCheckbox","CustomClassesCheckbox"];export{n as CheckedByDefaultCheckbox,m as CustomClassesCheckbox,p as CustomIdCheckbox,a as DefaultCheckbox,u as DescriptionSlotCheckbox,d as LabelSlotCheckbox,l as TileCheckbox,i as TileCheckedByDefaultCheckbox,c as TileWithDescriptionCheckbox,r as WithDescriptionCheckbox,Ue as __namedExportsOrder,Te as default};
