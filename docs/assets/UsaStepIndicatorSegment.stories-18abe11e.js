import{a as e,U as g}from"./UsaStepIndicator-aebfa7da.js";import"./vue.esm-bundler-d9807bdf.js";import"./UsaStepIndicatorHeader-1be696ee.js";import"./BaseHeading-19544782.js";const r={status:e.props.status.default,label:e.props.label.default},T={component:e,title:"Components/UsaStepIndicatorSegment",argTypes:{status:{options:["","current","completed"],control:{type:"select"}},label:{control:{type:"text"}}},args:{status:r.status},render:i=>({components:{UsaStepIndicator:g,UsaStepIndicatorSegment:e},props:Object.keys(e.props),setup(){return{args:i}},template:`
...
}`,...(u=(S=s.parameters)==null?void 0:S.docs)==null?void 0:u.source}}};const f=["DefaultStepIndicatorSegment","CurrentStepIndicatorSegment","CompletedStepIndicatorSegment"];export{s as CompletedStepIndicatorSegment,a as CurrentStepIndicatorSegment,t as DefaultStepIndicatorSegment,f as __namedExportsOrder,T as default};
