import{_ as r}from"./UsaFormGroup-COQiJYtU.js";import"./vue.esm-bundler-DlC1_45x.js";const e={group:r.props.group.default,error:r.props.error.default},F={component:r,title:"Components/UsaFormGroup",argTypes:{group:{control:{type:"boolean"}},error:{control:{type:"boolean"}},default:{control:{type:"text"}}},args:{group:e.group,error:e.error,default:'<label for="test-id">Test Input</label><input id="test-id" type="text" class="usa-input" />'},render:a=>({components:{UsaFormGroup:r},props:Object.keys(r.props),setup(){return{args:a}},template:`<UsaFormGroup
    :group="args.group"
    :error="args.error"
...
}`,...(g=(i=s.parameters)==null?void 0:i.docs)==null?void 0:g.source}}};const b=["DefaultFormGroup","GroupedFormGroup","ErrorFormGroup"];export{o as DefaultFormGroup,s as ErrorFormGroup,t as GroupedFormGroup,b as __namedExportsOrder,F as default};
