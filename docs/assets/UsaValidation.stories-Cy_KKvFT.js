import{s as c,w as C,c as D,J as j,a as B,g as E,m as A,b as f,v as M,H as K,o as V,f as F,t as z,n as Z}from"./vue.esm-bundler-DsKf3Hbt.js";import{o as G}from"./common-cfad2wKl.js";import{n as Q}from"./unique-id-ZGF68Crf.js";import{_ as W}from"./UsaAlert-Bby61V80.js";import{_ as X}from"./UsaChecklist-6hSkxeUu.js";import{r as Y}from"./index-CipSGTa_.js";import"./constants-BA52rpFi.js";import"./BaseHeading-CVYvBzV4.js";import"./UsaChecklistItem-DR15m5kr.js";const aa=["id"],t={__name:"UsaValidation",props:{validations:{type:Array,default:()=>[]},validationValue:{type:[String,Number],default:""},heading:{type:String,default:""},headingTag:{type:String,default:"h2"},validLabel:{type:String,default:"%s status complete"},invalidLabel:{type:String,default:"%s status incomplete"},id:{type:String,default:""},customClasses:{type:Object,default:()=>({body:[],heading:[],checklist:[]})}},emits:["update:validationId","update:statusMessageId"],setup(n,{emit:P}){const b=P,d=n,l=c(()=>d.id||Q("usa-validation")),v=c(()=>`${l.value}-status-message`),y=c(()=>d.validations.reduce((o,a)=>{const e={id:a!=null&&a.id&&`${a.id}`?a.id:a.text,text:a.text};if(G(a,"checked"))e.checked=a.checked;else if(typeof(a==null?void 0:a.validator)=="string"){const r=new RegExp(a.validator,"g");e.checked=r.test(`${d.validationValue}`)}else typeof(a==null?void 0:a.validator)=="object"&&a.validator instanceof RegExp?e.checked=a.validator.test(`${d.validationValue}`):typeof(a==null?void 0:a.validator)=="function"?e.checked=a.validator(d.validationValue)===!0:e.checked=!1;return e.ariaLabel=e.checked===!0?d.validLabel.replaceAll("%s",e.text):d.invalidLabel.replaceAll("%s",e.text),o.push(e),o},[])),R=Y(c(()=>y.value.map(o=>`${o.ariaLabel}.`).join(" ")),1e3);return C(l,()=>b("update:validationId",l),{immediate:!0}),C(v,()=>b("update:statusMessageId",v),{immediate:!0}),(o,a)=>(V(),D(K,null,[j(f(W),A(o.$attrs,{variant:"validation",heading:n.heading,"heading-tag":n.headingTag,"custom-classes":n.customClasses}),{message:E(()=>{var e,r;return[(e=y.value)!=null&&e.length?(V(),F(f(X),{key:0,id:l.value,items:y.value,class:Z((r=n.customClasses)==null?void 0:r.checklist)},null,8,["id","items","class"])):z("",!0)]}),_:1},16,["heading","heading-tag","custom-classes"]),B("span",{id:v.value,"data-validation-status":"",class:"usa-sr-only","aria-live":"polite","aria-atomic":"true"},M(f(R)),9,aa)],64))}};t.__docgenInfo={exportName:"default",displayName:"UsaValidation",type:1,props:[{name:"key",global:!0,description:"",tags:[],required:!1,type:"PropertyKey",declarations:[],schema:{kind:"enum",type:"PropertyKey",schema:["string","number","symbol"]}},{name:"ref",global:!0,description:"",tags:[],required:!1,type:"VNodeRef",declarations:[],schema:{kind:"enum",type:"VNodeRef",schema:["string","Ref<any, any>",{kind:"event",type:"(ref: Element | ComponentPublicInstance<{}, {}, {}, {}, {}, {}, {}, {}, false, ComponentOptionsBase<any, any, any, any, any, any, any, any, any, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>, ... 4 more ..., any>, refs: Record<...>): void"}]}},{name:"ref_for",global:!0,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"ref_key",global:!0,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"},{name:"class",global:!0,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"},{name:"style",global:!0,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"},{name:"headingTag",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string",default:'"h2"'},{name:"id",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string",default:'""'},{name:"customClasses",global:!1,description:"",tags:[],required:!1,type:"Record<string, any>",declarations:[],schema:"Record<string, any>",default:`{
	...
	checklist: ['test-checklist-class'] }"></UsaValidation>`}}}};var k,L,S;g.parameters={...g.parameters,docs:{...(k=g.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
...
}`,...(S=(L=g.parameters)==null?void 0:L.docs)==null?void 0:S.source}}};var U,T,I;u.parameters={...u.parameters,docs:{...(U=u.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
...
}`,...(I=(T=u.parameters)==null?void 0:T.docs)==null?void 0:I.source}}};var x,q,H;m.parameters={...m.parameters,docs:{...(x=m.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    heading: 'Custom Heading Tag',
    id: 'test-id',
...
}`,...(H=(q=m.parameters)==null?void 0:q.docs)==null?void 0:H.source}}};var N,$,w;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    heading: 'Custom Heading Tag',
    validLabel: 'is valid',
...
}`,...(w=($=p.parameters)==null?void 0:$.docs)==null?void 0:w.source}}};var O,_,J;h.parameters={...h.parameters,docs:{...(O=h.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
...
}`,...(J=(_=h.parameters)==null?void 0:_.docs)==null?void 0:J.source}}};const ga=["DefaultValidation","HeadingTagValidation","CustomIdValidation","CustomValidityLabelsValidation","CustomClassesValidation"];export{h as CustomClassesValidation,m as CustomIdValidation,p as CustomValidityLabelsValidation,g as DefaultValidation,u as HeadingTagValidation,ga as __namedExportsOrder,ca as default};
