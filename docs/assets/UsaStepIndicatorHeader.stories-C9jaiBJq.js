import{_ as e}from"./UsaStepIndicatorHeader-ClJa5eh1.js";import"./vue.esm-bundler-DsKf3Hbt.js";import"./BaseHeading-CVYvBzV4.js";const t={headingTag:e.props.headingTag.default,customClasses:e.props.customClasses.default()},s=["Test step 1","Test step 2","Test step 3"],I={component:e,title:"Components/UsaStepIndicatorHeader",argTypes:{currentStepNumber:{control:{type:"number",min:1,max:s.length+1}},currentStepLabel:{control:{type:"text"}},totalSteps:{control:{type:"number",min:1,max:s.length+1}},headingTag:{options:["h1","h2","h3","h4","h5","h6"],control:{type:"select"}},customClasses:{control:{type:"object"}}},args:{currentStepNumber:1,currentStepLabel:s[0],totalSteps:s.length,headingTag:t.headingTag,customClasses:t.customClasses},render:S=>({components:{UsaStepIndicatorHeader:e},props:Object.keys(e.props),setup(){return{args:S}},template:`<UsaStepIndicatorHeader
