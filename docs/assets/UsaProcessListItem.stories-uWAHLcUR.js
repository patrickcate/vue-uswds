import{_ as e,a as S}from"./UsaProcessListItem-B5Dmm0fH.js";import"./vue.esm-bundler-DlC1_45x.js";import"./BaseHeading-BkBCpxXB.js";const s={heading:e.props.heading.default,headingTag:e.props.headingTag.default,customClasses:e.props.customClasses.default()},T={component:e,title:"Components/UsaProcessListItem",argTypes:{heading:{control:{type:"text"},table:{category:"props"}},headingTag:{options:["h1","h2","h3","h4","h5","h6"],control:{type:"select"}},customClasses:{control:{type:"object"}},"slot:heading":{control:{type:"text"},name:"heading",table:{category:"slots"}},default:{control:{type:"text"}}},args:{heading:s.heading,headingTag:s.headingTag,customClasses:s.customClasses,"slot:heading":"",default:"<p>Nullam sit amet enim. Suspendisse id velit vitae ligula volutpat condimentum. Aliquam erat volutpat. Sed quis velit. Nulla facilisi. Nulla libero. Vivamus pharetra posuere sapien.</p>"},render:n=>({components:{UsaProcessList:S,UsaProcessListItem:e},props:Object.keys(e.props),setup(){return{args:n}},template:`
    <UsaProcessList>
...
</UsaProcessListItem>`}}}};var c,i,m;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
...
}`,...(m=(i=a.parameters)==null?void 0:i.docs)==null?void 0:m.source}}};var d,g,l;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    heading: 'Start a process',
    headingTag: 'h4'
