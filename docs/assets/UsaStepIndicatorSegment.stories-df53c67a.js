import{a as e,U as g}from"./UsaStepIndicator-972b4313.js";import"./vue.esm-bundler-2e7cedae.js";import"./UsaStepIndicatorHeader-378d4f36.js";import"./BaseHeading-0ea88faf.js";const r={status:e.props.status.default,label:e.props.label.default},T={component:e,title:"Components/UsaStepIndicatorSegment",argTypes:{status:{options:["","current","completed"],control:{type:"select"}},label:{control:{type:"text"}}},args:{status:r.status},render:i=>({components:{UsaStepIndicator:g,UsaStepIndicatorSegment:e},props:Object.keys(e.props),setup(){return{args:i}},template:`
