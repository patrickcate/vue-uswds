...
</UsaCollectionItem>`}}}},i={args:{...e,heading:"Collection w/ Meta Items",media:H,meta:`<UsaCollectionMeta aria-label="Topics">
...
</UsaCollectionItem>`}}}},r={args:{...e,headingTag:"h4",heading:"Custom heading tag"},name:"Custom Heading Tag",parameters:{docs:{source:{code:`<UsaCollectionItem heading="Custom heading tag" heading-tag="h4">Today, the Administration announces the winners of the Gears of Government President's Award. This program recognizes the contributions of individuals and teams across the federal workforce who make a profound difference in the lives of the American people.</UsaCollectionItem>`}}}},l={args:{...e,"slot:heading":"Custom header slot"},name:"Header Slot",parameters:{docs:{source:{code:`<UsaCollectionItem heading-tag="h4"><template #heading>Custom header slot</template><template #default>Today, the Administration announces the winners of the Gears of Government President's Award. This program recognizes the contributions of individuals and teams across the federal workforce who make a profound difference in the lives of the American people.</template></UsaCollectionItem>`}}}},c={args:{...e,heading:"Collection Item w/ description slot",description:"Custom description slot"},name:"Description Slot",parameters:{docs:{source:{code:`<UsaCollectionItem heading="Collection Item w/ description slot"><template #heading>Custom header slot</template><template #description>Custom description slot</template><template #default>Today, the Administration announces the winners of the Gears of Government President's Award. This program recognizes the contributions of individuals and teams across the federal workforce who make a profound difference in the lives of the American people.</template></UsaCollectionItem>`}}}},d={args:{...e,heading:"Collection Item",customClasses:{media:["test-media-class"],heading:["test-heading-class"],link:["test-link-class"],description:["test-description-class"]}},name:"Custom Classes",parameters:{docs:{source:{code:`<UsaCollectionItem heading="Collection Item" :custom-classes="{ media: ['test-media-class'],
...
}`,...(b=(G=l.parameters)==null?void 0:G.docs)==null?void 0:b.source}}};var P,z,S;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
...
}`,...(S=(z=c.parameters)==null?void 0:z.docs)==null?void 0:S.source}}};var x,_,D;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    heading: 'Collection Item',
    customClasses: {
...
}`,...(D=(_=d.parameters)==null?void 0:_.docs)==null?void 0:D.source}}};const W=["DefaultCollectionItem","MediaCollectionItem","CalendarCollectionItem","MetaItemsCollectionItem","CustomHeadingTagCollectionItem","HeadingSlotCollectionItem","DescriptionSlotCollectionItem","CustomClassesCollectionItem"];export{s as CalendarCollectionItem,d as CustomClassesCollectionItem,r as CustomHeadingTagCollectionItem,o as DefaultCollectionItem,c as DescriptionSlotCollectionItem,l as HeadingSlotCollectionItem,n as MediaCollectionItem,i as MetaItemsCollectionItem,W as __namedExportsOrder,V as default};
