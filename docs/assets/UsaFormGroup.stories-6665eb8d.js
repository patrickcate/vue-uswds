import{U as r}from"./UsaFormGroup-c2b9f5da.js";import"./vue.esm-bundler-d9807bdf.js";const e={group:r.props.group.default,error:r.props.error.default},f={component:r,title:"Components/UsaFormGroup",argTypes:{group:{control:{type:"boolean"}},error:{control:{type:"boolean"}},default:{control:{type:"text"}}},args:{group:e.group,error:e.error,default:'<label for="test-id">Test Input</label><input id="test-id" type="text" class="usa-input" />'},render:a=>({components:{UsaFormGroup:r},props:Object.keys(r.props),setup(){return{args:a}},template:`<UsaFormGroup
    :group="args.group"
    :error="args.error"
