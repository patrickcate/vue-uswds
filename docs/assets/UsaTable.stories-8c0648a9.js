...
specified depth.`,tags:[{name:"param",text:"depth The maximum recursion depth"}],required:!0,type:"<A, D extends number = 1>(this: A, depth?: D) => FlatArray<A, D>[]",declarations:[],schema:{kind:"event",type:"<A, D extends number = 1>(this: A, depth?: D): FlatArray<A, D>[]"}},{name:"__@iterator@1083",global:!1,description:"Iterator",tags:[],required:!0,type:"() => ArrayIterator<any>",declarations:[],schema:{kind:"event",type:"(): ArrayIterator<any>"}},{name:"__@unscopables@1085",global:!1,description:`Is an object whose properties have the value 'true'
...
:rows="${JSON.stringify(l,null,"	")}" :compact="true"></UsaTable>`}}}},E={args:{...d,headers:o.map(({...e})=>(e.sortable=!1,e)),rows:l,scrollable:!0,caption:"Resize to small screen..."},name:"Scrollable",parameters:{docs:{source:{code:`<UsaTable :headers="${JSON.stringify(o.map(({...e})=>(e.sortable=!1,e)),null,"	")}" 
:rows="${JSON.stringify(l,null,"	")}" :scrollable="true" caption="Resize to small screen..."></UsaTable>`}}}},L={args:{...d,headers:o.map(({...e})=>(e.sortable=!1,e)),rows:l,stacked:!0,caption:"Resize to small screen..."},name:"Stacked",parameters:{docs:{source:{code:`<UsaTable :headers="${JSON.stringify(o.map(({...e})=>(e.sortable=!1,e)),null,"	")}" 
:rows="${JSON.stringify(l,null,"	")}" :stacked="true" caption="Resize to small screen..."></UsaTable>`}}}},z={args:{...d,headers:o.map(({...e})=>(e.sortable=!1,e)),rows:l,stackedHeader:!0,caption:"Resize to small screen..."},name:"Stacked Header",parameters:{docs:{source:{code:`<UsaTable :headers="${JSON.stringify(o.map(({...e})=>(e.sortable=!1,e)),null,"	")}" 
:rows="${JSON.stringify(l,null,"	")}" :stacked-header="true" caption="Resize to small screen..."></UsaTable>`}}}},F={args:{...d,headers:o,rows:l},name:"Sortable",parameters:{docs:{source:{code:`<UsaTable :headers="${JSON.stringify(o,null,"	")}" 
:rows="${JSON.stringify(l,null,"	")}"></UsaTable>`}}}},_={args:{...d,headers:o,rows:l,defaultSortHeader:"percent",defaultSortDirection:"descending"},name:"Sortable w/ Defaults",parameters:{docs:{source:{code:`<UsaTable :headers="${JSON.stringify(o,null,"	")}" 
...
}`,...(we=(Se=P.parameters)==null?void 0:Se.docs)==null?void 0:we.source}}};var ke,Te,xe;E.parameters={...E.parameters,docs:{...(ke=E.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders.map(({
      ...header
...
}`,...(xe=(Te=E.parameters)==null?void 0:Te.docs)==null?void 0:xe.source}}};var He,Ae,Ue;L.parameters={...L.parameters,docs:{...(He=L.parameters)==null?void 0:He.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders.map(({
      ...header
...
}`,...(Ue=(Ae=L.parameters)==null?void 0:Ae.docs)==null?void 0:Ue.source}}};var Ie,Re,Ce;z.parameters={...z.parameters,docs:{...(Ie=z.parameters)==null?void 0:Ie.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders.map(({
      ...header
...
}`,...(Ce=(Re=z.parameters)==null?void 0:Re.docs)==null?void 0:Ce.source}}};var $e,Ve,Oe;F.parameters={...F.parameters,docs:{...($e=F.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders,
    rows: testRows
...
}`,...(Oe=(Ve=F.parameters)==null?void 0:Ve.docs)==null?void 0:Oe.source}}};var Ne,De,qe;_.parameters={..._.parameters,docs:{...(Ne=_.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders,
    rows: testRows,
...
}`,...(qe=(De=_.parameters)==null?void 0:De.docs)==null?void 0:qe.source}}};var Je,je,Pe;M.parameters={...M.parameters,docs:{...(Je=M.parameters)==null?void 0:Je.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders.map(({
      ...header
...
}`,...(Pe=(je=M.parameters)==null?void 0:je.docs)==null?void 0:Pe.source}}};var Ee,Le,ze;B.parameters={...B.parameters,docs:{...(Ee=B.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders.map(({
      ...header
...
}`,...(ze=(Le=B.parameters)==null?void 0:Le.docs)==null?void 0:ze.source}}};var Fe,_e,Me;K.parameters={...K.parameters,docs:{...(Fe=K.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders.map(({
      ...header
...
}`,...(Me=(_e=K.parameters)==null?void 0:_e.docs)==null?void 0:Me.source}}};var Be,Ke,Ge;G.parameters={...G.parameters,docs:{...(Be=G.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders,
    rows: testRows,
...
}`,...(Ge=(Ke=G.parameters)==null?void 0:Ke.docs)==null?void 0:Ge.source}}};const ya=["DefaultTable","CaptionTable","BorderlessTable","StripedTable","CompactTable","ScrollableTable","StackedTable","StackedHeaderTable","SortableTable","DefaultSortTable","CaptionSlotTable","HeadersSlotTable","DefaultRowsSlotTable","TableAnnouncementSlotTable"];export{J as BorderlessTable,M as CaptionSlotTable,q as CaptionTable,P as CompactTable,K as DefaultRowsSlotTable,_ as DefaultSortTable,D as DefaultTable,B as HeadersSlotTable,E as ScrollableTable,F as SortableTable,z as StackedHeaderTable,L as StackedTable,j as StripedTable,G as TableAnnouncementSlotTable,ya as __namedExportsOrder,fa as default};
