...
specified depth.`,tags:[{name:"param",text:"depth The maximum recursion depth"}],required:!0,type:"<A, D extends number = 1>(this: A, depth?: D) => FlatArray<A, D>[]",declarations:[],schema:{kind:"event",type:"<A, D extends number = 1>(this: A, depth?: D): FlatArray<A, D>[]"}},{name:"__@iterator@858",global:!1,description:"Iterator",tags:[],required:!0,type:"() => ArrayIterator<any>",declarations:[],schema:{kind:"event",type:"(): ArrayIterator<any>"}},{name:"__@unscopables@860",global:!1,description:`Is an object whose properties have the value 'true'
...
:rows="${JSON.stringify(l,null,"	")}" :borderless="true"></UsaTable>`}}}},P={args:{...d,headers:o.map(({...e})=>(e.sortable=!1,{...e})),rows:l,striped:!0},name:"Striped",parameters:{docs:{source:{code:`<UsaTable :headers="${JSON.stringify(o.map(({...e})=>(e.sortable=!1,e)),null,"	")}" 
:rows="${JSON.stringify(l,null,"	")}" :striped="true"></UsaTable>`}}}},j={args:{...d,headers:o.map(({...e})=>(e.sortable=!1,e)),rows:l,compact:!0},name:"Compact",parameters:{docs:{source:{code:`<UsaTable :headers="${JSON.stringify(o.map(({...e})=>(e.sortable=!1,e)),null,"	")}" 
...
}`,...(fe=(he=J.parameters)==null?void 0:he.docs)==null?void 0:fe.source}}};var ye,be,ge;P.parameters={...P.parameters,docs:{...(ye=P.parameters)==null?void 0:ye.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders.map(({
      ...header
...
}`,...(ge=(be=P.parameters)==null?void 0:be.docs)==null?void 0:ge.source}}};var ve,Se,we;j.parameters={...j.parameters,docs:{...(ve=j.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders.map(({
      ...header
...
}`,...(we=(Se=j.parameters)==null?void 0:Se.docs)==null?void 0:we.source}}};var ke,Te,xe;_.parameters={..._.parameters,docs:{...(ke=_.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders.map(({
      ...header
...
}`,...(Ce=(Re=L.parameters)==null?void 0:Re.docs)==null?void 0:Ce.source}}};var $e,Ve,Oe;z.parameters={...z.parameters,docs:{...($e=z.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders,
    rows: testRows
...
}`,...(Oe=(Ve=z.parameters)==null?void 0:Ve.docs)==null?void 0:Oe.source}}};var Ne,De,qe;F.parameters={...F.parameters,docs:{...(Ne=F.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders,
    rows: testRows,
...
}`,...(qe=(De=F.parameters)==null?void 0:De.docs)==null?void 0:qe.source}}};var Je,Pe,je;M.parameters={...M.parameters,docs:{...(Je=M.parameters)==null?void 0:Je.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders.map(({
      ...header
...
}`,...(je=(Pe=M.parameters)==null?void 0:Pe.docs)==null?void 0:je.source}}};var _e,Ee,Le;B.parameters={...B.parameters,docs:{...(_e=B.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    headers: testHeaders.map(({
      ...header
