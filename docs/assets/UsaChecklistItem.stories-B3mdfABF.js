import{_ as a}from"./UsaChecklistItem-C0D488mm.js";import"./vue.esm-bundler-DlC1_45x.js";const r={checked:a.props.checked.default},f={component:a,title:"Components/UsaChecklistItem",argTypes:{checked:{control:{type:"boolean"}},ariaLabel:{control:{type:"text"}}},args:{checked:r.checked,ariaLabel:""},decorators:[()=>({template:'<ul class="usa-checklist" style="margin-left: 40px"><story /></ul>'})],render:c=>({components:{UsaChecklistItem:a},props:Object.keys(a.props),setup(){return{args:c}},template:`<UsaChecklistItem :checked="args.checked" :aria-label="args.ariaLabel">
