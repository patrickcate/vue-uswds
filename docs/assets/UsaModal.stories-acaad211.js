...
}`},{name:"heading",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string",default:'""'},{name:"closeButtonLabel",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string",default:'"Close this window"'},{name:"visible",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]},default:"false"},{name:"forceAction",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]},default:"false"}],events:[{name:"update:visible",description:"",tags:[],type:"any[]",signature:'(event: "update:visible", ...args: any[]): void',declarations:[],schema:["any"]}],slots:[{name:"heading",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}},{name:"default",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}},{name:"footer",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}},{name:"close-button",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}},{name:"closeButton",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}}],exposed:[{name:"size",type:"string",description:"",declarations:[],schema:"string"},{name:"headingTag",type:"string",description:"",declarations:[],schema:"string"},{name:"id",type:"string",description:"",declarations:[],schema:"string"},{name:"customClasses",type:"Record<string, any>",description:"",declarations:[],schema:"Record<string, any>"},{name:"heading",type:"string",description:"",declarations:[],schema:"string"},{name:"closeButtonLabel",type:"string",description:"",declarations:[],schema:"string"},{name:"visible",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"forceAction",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}}],sourceFiles:"/home/runner/work/vue-uswds/vue-uswds/src/components/UsaModal/UsaModal.vue"};const a={size:o.props.size.default,id:o.props.id.default,visible:o.props.visible.default,forceAction:o.props.forceAction.default,heading:o.props.heading.default,headingTag:o.props.headingTag.default,closeButtonLabel:o.props.closeButtonLabel.default,customClasses:o.props.customClasses.default()},Ze={component:o,title:"Components/UsaModal",argTypes:{size:{options:["","lg"],control:{type:"select"}},id:{control:{type:"text"}},visible:{control:{type:"boolean"}},forceAction:{control:{type:"boolean"}},closeButtonLabel:{control:{type:"text"}},heading:{control:{type:"text"},table:{category:"props"}},headingTag:{options:["h1","h2","h3","h4","h5","h6"],control:{type:"select"}},customClasses:{control:{type:"object"}},default:{control:{type:"text"}},"slot:heading":{control:{type:"text"},name:"heading",table:{category:"slots"}},footer:{control:{type:"text"}},"close-button":{control:{type:"text"}},closeButton:{control:{type:"text"},name:"closeButton (deprecated: use `close-button`)"}},args:{size:a.size,id:a.id,visible:a.visible,forceAction:a.forceAction,closeButtonLabel:a.closeButtonLabel,heading:a.heading,headingTag:a.headingTag,customClasses:a.customClasses,default:"<p>You have unsaved changes that will be lost.</p>","slot:heading":"",footer:`<ul class="usa-button-group">
