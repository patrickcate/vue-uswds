import{B as e}from"./BaseLink-05a2e488.js";import"./constants-fce87d39.js";import"./vue.esm-bundler-2e7cedae.js";import"./_plugin-vue_export-helper-c27b6911.js";const r={href:e.props.href.default,to:e.props.to.default,routerComponentName:e.props.routerComponentName.default},k={component:e,title:"Components/BaseLink",argTypes:{href:{control:{type:"text"}},to:{control:{type:"text"}},routerComponentName:{control:{type:"text"}},default:{control:{type:"text"}}},args:{href:r.href,to:r.to,routerComponentName:r.routerComponentName,default:""},render:f=>({components:{BaseLink:e},props:Object.keys(e.props),setup(){return{args:f}},template:`<BaseLink
      :href="args.href"
      :to="args.to"
