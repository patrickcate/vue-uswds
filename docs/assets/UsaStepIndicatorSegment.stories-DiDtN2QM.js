import{_ as e,a as g}from"./UsaStepIndicator-B7ftSD5k.js";import"./vue.esm-bundler-DlC1_45x.js";import"./UsaStepIndicatorHeader-DmF4OI4t.js";import"./BaseHeading-BkBCpxXB.js";const r={status:e.props.status.default,label:e.props.label.default},f={component:e,title:"Components/UsaStepIndicatorSegment",argTypes:{status:{options:["","current","completed"],control:{type:"select"}},label:{control:{type:"text"}}},args:{status:r.status},render:i=>({components:{UsaStepIndicator:g,UsaStepIndicatorSegment:e},props:Object.keys(e.props),setup(){return{args:i}},template:`
