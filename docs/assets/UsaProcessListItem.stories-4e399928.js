import{a as e,U as S}from"./UsaProcessListItem-5da8f3df.js";import"./vue.esm-bundler-d9807bdf.js";import"./BaseHeading-19544782.js";const s={heading:e.props.heading.default,headingTag:e.props.headingTag.default,customClasses:e.props.customClasses.default()},T={component:e,title:"Components/UsaProcessListItem",argTypes:{heading:{control:{type:"text"},table:{category:"props"}},headingTag:{options:["h1","h2","h3","h4","h5","h6"],control:{type:"select"}},customClasses:{control:{type:"object"}},"slot:heading":{control:{type:"text"},name:"heading",table:{category:"slots"}},default:{control:{type:"text"}}},args:{heading:s.heading,headingTag:s.headingTag,customClasses:s.customClasses,"slot:heading":"",default:"<p>Nullam sit amet enim. Suspendisse id velit vitae ligula volutpat condimentum. Aliquam erat volutpat. Sed quis velit. Nulla facilisi. Nulla libero. Vivamus pharetra posuere sapien.</p>"},render:n=>({components:{UsaProcessList:S,UsaProcessListItem:e},props:Object.keys(e.props),setup(){return{args:n}},template:`
    <UsaProcessList>
