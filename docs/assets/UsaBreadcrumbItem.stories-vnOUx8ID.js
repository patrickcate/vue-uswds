import{_ as e,a as g}from"./UsaBreadcrumb-BvCPIsVg.js";import"./vue.esm-bundler-DsKf3Hbt.js";import"./BaseLink-BYp1-IWJ.js";import"./constants-BA52rpFi.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const r={href:e.props.href.default,to:e.props.to.default,routerComponentName:e.props.routerComponentName.default,current:e.props.current.default,customClasses:e.props.customClasses.default()},h={component:e,title:"Components/UsaBreadcrumbItem",argTypes:{href:{control:{type:"text"}},to:{control:{type:"text"}},routerComponentName:{control:{type:"text"}},current:{control:{type:"boolean"}},customClasses:{control:{type:"object"}},default:{control:{type:"text"}}},args:{href:r.href,to:r.to,routerComponentName:r.routerComponentName,current:r.current,customClasses:r.customClasses,default:"Test breadcrumb"},render:f=>({components:{UsaBreadcrumb:g,UsaBreadcrumbItem:e},props:Object.keys(e.props),setup(){return{args:f}},template:`<UsaBreadcrumb>
    <UsaBreadcrumbItem
      :href="args.href"
      :to="args.to"
